...
namespace Game
{
  ...
  void SlotsLayout::AddSlotBLeft(const std::string &name) {
    ...
    const mtVec2f cursor = l_slot_b.cursor = {l_slot_a.box.btmRightX + (float) gap, l_slot_a.box.topLeftY};
  ...
  void SlotsLayout::AddSlotCLeft(const std::string &name) {
    ...
    const mtVec2f cursor = l_slot_c.cursor = {l_slot_b.box.btmRightX + (float) gap, l_slot_b.box.topLeftY};
  ...
  void SlotsLayout::AddSlotBRight(const std::string &name) {
    ...
    const mtVec2f cursor = r_slot_b.cursor = {r_slot_a.box.btmRightX - (float) gap, r_slot_a.box.topLeftY};
    r_slot_b.box.topLeftX = cursor.x;
    r_slot_b.box.topLeftY = cursor.y;
    r_slot_b.box.btmRightX = cursor.x + unitSize.x;
    r_slot_b.box.btmRightY = cursor.y + unitSize.y;
